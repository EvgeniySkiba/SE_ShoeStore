<%@ Page Title="" Language="C#" MasterPageFile="~/Back_End/Admin.Master" AutoEventWireup="true"
    CodeBehind="Color.aspx.cs" Inherits="ShoeStore.Back_End.Color" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    Редактирование текущих цветовых значений
    <br /><%--
    ...
    <asp:GridView ID="GridView1"  runat="server" GridLines="None" AutoGenerateColumns="False"
            ...
            ForeColor="Black" DataKeyNames="ID"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ColorName" HeaderText="Название" />
        </Columns>
        ...
        <fieldset>
            ...
            <div style="float: inherit; margin:10px; width: 250px;">
                <div style="width: 100px; float: left; margin-right: 1px;">
                    <asp:Button runat="server" Width="100px" Text="Сохранить" OnClick="Unnamed1_Click" />
                </div>
                <div style="width: 100px; margin-left: 110px; ">
                    <asp:Button ID="Button1" Width="100px" runat="server" Text="Назад" OnClick="Button1_Click" />
                </div>
            </div> 
        </fieldset>
    </asp:Panel>
    ...
    <asp:Panel ID="pnlError" runat="server" Visible=false>
        ...
        SelectCommand="SELECT * FROM [ColorType]"
        UpdateCommand="UPDATE ColorType SET ColorName = @ColorName WHERE ID=@ID"        
        >
