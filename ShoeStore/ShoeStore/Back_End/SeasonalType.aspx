<%@ Page Title="" Language="C#" MasterPageFile="~/Back_End/Admin.Master" AutoEventWireup="true" CodeBehind="SeasonalType.aspx.cs" Inherits="ShoeStore.Back_End.SeasonalType" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>Редактирование сезонов</h3>
 ...
 <asp:Panel ID="pnlColors" runat="server" Visible="true" ClientIDMode="AutoID" Width="100px">
        ...
        <asp:GridView ID="GridView1" runat="server" GridLines="None" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Name" HeaderText="Название сезона" />           
            </Columns>
