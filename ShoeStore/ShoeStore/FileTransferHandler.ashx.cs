...
namespace jQueryUploadTest
{
    ...
    public class FileTransferHandler : IHttpHandler
    {
        ...
        //Custom
        private string CreateVirtualPath(string fullServerPath)
        {
            ...
            switch (context.Request.HttpMethod)
            {
                ...
                case "POST":
                 ...
                 UploadFile(context);
                     ...
                     string filePath = CreateVirtualPath(StorageRoot + context.Request.Files[0].FileName);


                    lresult = ShoeStore.Data.Product.Image.InsertImage(ProductId,
                         filePath,
                         string.Empty,
                         string.Empty,
                         true,
                         string.Empty,
                         context.Request.Files[0].ContentLength);  
